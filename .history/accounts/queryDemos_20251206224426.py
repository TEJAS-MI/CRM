...
lastCustomer = models.Customer.objects.last()
...
products = models.Product.objects.filter(category="Out Door")

#(9)***Order/Sort Objects by id
leastToGreatest = models.Product.objects.all().order_by('id') 
greatestToLeast = models.Product.objects.all().order_by('-id') 


#(10) Returns all products with tag of "Sports": (Query Many to Many Fields)
productsFiltered = models.Product.objects.filter(tags__name="Sports")
